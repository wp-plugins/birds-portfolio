        ...
        add_filter( 'template_include', function( $template ) {
            ...
            if ( ! in_array( $post_type, $birds_types ) ) {
                ...
                if(!is_file( $themetemplate ) ){
                    return plugin_dir_path( __FILE__ ) . 'assets/templates/single-portfolio.php';
                } else {
        ...
        */
        add_filter( 'template_include', function( $template ) {
            if ( is_post_type_archive( 'birds_portfolio' ) || is_tax( 'portfolio_categories' ) ) {
                ...
                if(!is_file( $themetemplate ) ){
                    return plugin_dir_path( __FILE__ ) . 'assets/templates/archive-portfolio.php';
                } else {
                    return $themetemplate ;
                }
            } else {
