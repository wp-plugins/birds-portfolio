...
class Birds_Portfolio_Main {
    ...
    private function __construct() {
        ...
        add_action( 'plugins_loaded', array( $this, 'birds_portfolio_single' ) );
        add_action( 'plugins_loaded', array( $this, 'birds_portfolio_archives' ) );
     ...
     */
    public function birds_portfolio_single() {
     ...
     */
    public function birds_portfolio_archives() {
        add_filter( 'template_include', function( $template ) {
